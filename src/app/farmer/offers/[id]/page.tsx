...
import { fetchFarmerOffer } from "@/lib/client/api-queries";
...
export default function FarmerOfferDetailPage() {
  ...
  const offerQuery = useQuery({
    queryKey: kvKeys.farmer(userId ?? "").offer(offerId),
    queryFn: () => fetchFarmerOffer(offerId),
  ...
  return <NegotiationDetail offer={offerQuery.data} role="farmer" />;
}