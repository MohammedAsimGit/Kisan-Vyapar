...
export default function FarmerDashboardPage() {
  ...
  if (produceQuery.isError) {
    return (
      <ScreenError
        ...
        description="We couldn't load your crops right now. Your data is safe — try again in a moment."
      />
    );
  }
  ...
  const firstName = session.data?.fullName.split(/\s+/)[0] ?? "farmer";
