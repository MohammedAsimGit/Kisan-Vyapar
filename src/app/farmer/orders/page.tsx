...
import { fetchFarmerOrders } from "@/lib/client/api-queries";
...
function FarmerOrdersContent() {
  ...
  const ordersQuery = useQuery({
    queryKey: kvKeys.farmer(userId ?? "").orders(page),
    queryFn: () => fetchFarmerOrders(page),
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      {result.orders.length === 0 ? (
        <EmptyState
          ...
          title="No orders yet"
          description="When you reach an agreement with a buyer, the order will appear here."
        />
      ) : (
        <>
